export const ERROR_CODES = {
  ...
  UPLOAD_LIST_FAILED: 'UPLOAD_LIST_FAILED',
  ...
  CHAT_PARTICIPANT_ALREADY_EXISTS: 'CHAT_PARTICIPANT_ALREADY_EXISTS',
  CART_NOT_FOUND: 'CART_NOT_FOUND',
  CART_ITEM_NOT_FOUND: 'CART_ITEM_NOT_FOUND',
  CART_INSUFFICIENT_STOCK: 'CART_INSUFFICIENT_STOCK',
  CART_PRODUCT_NOT_AVAILABLE: 'CART_PRODUCT_NOT_AVAILABLE',
  ORDER_NOT_FOUND: 'ORDER_NOT_FOUND',
  ORDER_UNAUTHORIZED_ACCESS: 'ORDER_UNAUTHORIZED_ACCESS',
  ORDER_CANNOT_CANCEL: 'ORDER_CANNOT_CANCEL',
  ORDER_CART_EMPTY: 'ORDER_CART_EMPTY',
  ORDER_NO_ITEMS_FOR_SELLER: 'ORDER_NO_ITEMS_FOR_SELLER',
  ORDER_SELLER_NOT_FOUND: 'ORDER_SELLER_NOT_FOUND',
  ...
  SELLER_SLUG_ALREADY_EXISTS: 'SELLER_SLUG_ALREADY_EXISTS',
