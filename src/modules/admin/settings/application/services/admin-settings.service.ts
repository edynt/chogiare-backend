...
const DEFAULT_SETTINGS: SystemSettingsData = {
  general: {
    ...
    siteUrl: 'https://chogiare.online',
    adminEmail: 'admin@chogiare.online',
    supportEmail: 'support@chogiare.online',
  ...
  notification: {
    ...
    pushEnabled: true,
    inAppEnabled: true,
    emailFrom: 'noreply@chogiare.online',
  ...
  seo: {
    ...
    canonicalUrl: 'https://chogiare.online',
    robotsTxt: true,
    sitemapEnabled: true,
