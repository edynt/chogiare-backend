...
export class UpdateStoreDto {
  @ApiPropertyOptional({ description: 'Store name', maxLength: 255 })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  name?: string;
  ...
  @ApiPropertyOptional({ description: 'Is verified store' })
  @IsOptional()
  @IsBoolean()
  isVerified?: boolean;

  @ApiPropertyOptional({ description: 'Is active store' })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;
}
